  ...
  return (
    <div className="mobilv-mobilv">
      <div className="mobilv-top-bar">
        ...
        <span className="mobilv-text10">Traffls</span>
      ...
      {menu === true && (
        <div className="mobilv-menu1">
          <div className="mobilv-bar">
            ...
            />
            <span className="mobilv-text11">Menu</span>
          ...
          <div className="mobilv-menu2">
            <div onClick={() => setMenu(false)} className="mobilv-container12">
              <span className="mobilv-text12">
                <span>Home</span>
                <br></br>
              </span>
            </div>
            <div onClick={() => setMenu(false)} className="mobilv-container13">
              <span className="mobilv-text15">About us</span>
            </div>
            <div className="mobilv-container14">
              <span className="mobilv-text16">Pricing</span>
            </div>
            <div className="mobilv-container15">
              <span className="mobilv-text17">How it Works</span>
            </div>
            <div className="mobilv-container16">
              <span className="mobilv-text18">Testimonials</span>
            </div>
            <div className="mobilv-container17">
              <span className="mobilv-text19">Contact us</span>
            </div>
          </div>
        </div>
      )}
      <div className="mobilv-content">
        <div id="home" className="mobilv-container18">
          <span className="mobilv-text20">
            <span className="mobilv-text21">Increase</span>
            <span> your</span>
            <br></br>
            <span>
              Leadflow by
            ...
            <span className="mobilv-text25">30%</span>
            <span>
              <span
                dangerouslySetInnerHTML={{
                  __html: ' ',
            ...
            <span className="mobilv-text29">3 months</span>
          </span>
          <span className="mobilv-text30">
        ...
        <div className="mobilv-container22">
          <div className="mobilv-container23">
            <span className="mobilv-text33 title">
              <span className="mobilv-text34">B2B Leads</span>
              <span> without Risk</span>
            </span>
            <span className="mobilv-text36 txt">
        ...
        <div id="aboutUs" className="mobilv-container25">
          <span className="mobilv-text37">
            ...
            <span className="mobilv-text39">traffls?</span>
          </span>
          <div className="mobilv-container26">
            <span className="mobilv-text40">
            ...
            <span className="mobilv-text41"> </span>
            <span className="mobilv-text42">
        ...
        <div className="mobilv-container28">
          <div className="mobilv-container29">
            ...
            <div className="mobilv-container31">
              <span className="mobilv-text44">Guaranteed Leads</span>
              <span className="mobilv-text45">
          ...
          <div className="mobilv-container32">
            ...
            <div className="mobilv-container34">
              <span className="mobilv-text46">Guaranteed positive ROI</span>
              <span className="mobilv-text47">
        ...
        <div className="mobilv-container36">
          <div className="mobilv-container37">
            <span className="mobilv-text49 title">
              <span>
                Start Your
                <span
                  dangerouslySetInnerHTML={{
              ...
              <span className="mobilv-text51">Lead Engine</span>
            </span>
            <span className="mobilv-text52 txt">
          ...
          <div className="mobilv-container38">
            <div className="mobilv-container39">
              <div className="mobilv-container40">
                ...
                <span className="mobilv-text53">No Upfront Costs</span>
                <span className="mobilv-text54">
              ...
              <div className="mobilv-container42">
                ...
                <span className="mobilv-text55">No Monthly Fee</span>
                <span className="mobilv-text56">
            ...
            <div className="mobilv-container44">
              <div className="mobilv-container45">
                ...
                <span className="mobilv-text57">No Minimum Contract</span>
                <span className="mobilv-text58">
              ...
              <div id="test" className="mobilv-container47">
                ...
                <span className="mobilv-text59">Ongoing Support</span>
                <span className="mobilv-text60">
        ...
        <div className="mobilv-container49">
          <span className="mobilv-text61">
            <span className="mobilv-text62">Getting More</span>
            <span>
              {' '}
            ...
            <span className="mobilv-text64">Easy</span>
          </span>
            ...
            <div className="mobilv-container51">
              <div className="mobilv-container52">
                ...
                <div className="mobilv-container55">
                  <span className="mobilv-text66">Book A Call</span>
                  <span>
              ...
              <div className="mobilv-container56">
                ...
                <div className="mobilv-container59">
                  <span className="mobilv-text69">Offer</span>
                  <span>
            ...
            <div className="mobilv-container60">
              <div className="mobilv-container61">
                ...
                <div className="mobilv-container64">
                  <span className="mobilv-text72">Onboarding</span>
                  <span>
              ...
              <div className="mobilv-container65">
                ...
                <div className="mobilv-container68">
                  <span className="mobilv-text75">Done</span>
                  <span>
        ...
        <div className="mobilv-container69">
          <span className="mobilv-text77">
            <span className="mobilv-text78">Pricing</span>
            <span> that fits you</span>
          </span>
          <div className="mobilv-container70"></div>
          <div className="mobilv-container71"></div>
        </div>
        <div className="mobilv-container72">
          <span className="mobilv-text80">
            <span>
              Hear from Our
              <span
                dangerouslySetInnerHTML={{
            ...
            <span className="mobilv-text82">Satisfied Clients</span>
          </span>
        </div>
        <div className="mobilv-container73">
          <div className="mobilv-container74">
            <span className="mobilv-text83">
              <span>
                Book a
                <span
                  dangerouslySetInnerHTML={{
              ...
              <span className="mobilv-text85">Discovery Call</span>
            </span>
            <span>
        ...
        <div className="mobilv-container78">
          <span className="mobilv-text87">
            <span className="mobilv-text88">Contact</span>
            <span> Us</span>
          </span>
          ...
          <div className="mobilv-container93 btn-1">
            <span>Submit</span>
          </div>
        </div>
        <div className="mobilv-container94">
          <span className="mobilv-text96">Traffls </span>
          <div className="mobilv-container95">
            ...
            <div className="mobilv-container97">
              <span className="mobilv-text99 titel-2">Contact info</span>
              <div className="mobilv-container98">
                ...
                <span className="text mobilv-text101">
